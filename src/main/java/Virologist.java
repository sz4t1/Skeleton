...
public class Virologist {
    //src.main.java.Virologist constructor
    public Virologist(){
        System.out.println("src.main.java.Virologist constructed");
    }
    ...
    public void AddVirus(Virus v){
        System.out.println("AddVirus(src.main.java.Virus v)");
    }
    //Add equipment to the virologists inventory
    public void AddEquipment(Equipment e){
        System.out.println("AddEquipment(src.main.java.Equipment e)");
    }
    //Remove material from the virologists inventory
    public void RemoveMaterial(Material m){
        System.out.println("RemoveMaterial(src.main.java.Material m)");
    }
    ...
    public void RemoveEquipment(Equipment e){
        System.out.println("RemoveEquipment(src.main.java.Equipment e)");
    }
    //src.main.java.Virologist move to another field that was given as a parameter
    public void Move(Field f){
        System.out.println("Move(src.main.java.Field f)");
    }
    ...
    public void CraftVirus(Virus v){
        System.out.println("CraftVirus(src.main.java.Virus v)");
    }
